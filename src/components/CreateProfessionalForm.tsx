...
//   const { register, handleSubmit, formState: { errors, isSubmitting }, reset } = useForm<ProfessionalFormData>();
...
//                   })}
//                   className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-500 text-gray-900 bg-white text-sm"
...
//                     maxLength: { value: 100, message: 'Cargo deve ter no máximo 100 caracteres' } 
//                   })}
//                   className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 placeholder-gray-500 text-gray-900 bg-white text-sm"
...
//                   type="text"
//                   {...register('contact', {
//                     maxLength: { value: 20, message: 'Contato deve ter no máximo 20 caracteres' },
//                     pattern: {
//                       value: /^\+?\d{0,20}$/,
...
//                 whileTap={{ scale: 0.98 }}
//                 className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-3 px-6 rounded-lg font-semibold text-sm tracking-wide shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
//               >
//                 {isSubmitting ? (
//                   <>
