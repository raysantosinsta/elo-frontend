      ...
      if (initialData) {
        form.reset({
          ...
          dueDate: initialData.dueDate
            ...
            : "",
          scheduledAt: initialData.scheduledDate
        ...
        const defaultCol =
          initialColumnId || (columns.length > 0 ? columns[0].id : "");
        form.reset({
            ...
            >
              <Tabs defaultValue="info" className="w-full">
                ...
                <TabsContent value="info" className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Próximo a atrasar</FormLabel>
                          <FormControl>
                            <Input
                              type="date"
                              {...field}
                ...
                <TabsContent value="address" className="space-y-5">
                  <div className="p-4 bg-slate-50 border rounded-lg space-y-2">
                    <Label className="text-xs font-bold text-slate-500 uppercase flex items-center gap-2">
                      <Search size={12} /> Preenchimento Rápido
                    </Label>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <Input {...field} placeholder="Ex: Apto 101" />
                      </FormItem>
                    )}
                  />
                ...
                <TabsContent value="media" className="space-y-6">
                  {isEditing &&
                  (initialData?.taskImages.length ||
                    initialData?.taskVideos.length ||
                    initialData?.taskAudios.length) ? (
                    <div className="space-y-6 p-4 bg-slate-50 border rounded-lg">
                      ...
                      {initialData.taskVideos.length > 0 && (
                        <div className="grid grid-cols-2 gap-3">
                          {initialData.taskVideos.map(
                            (video) =>
                              !removedVideoIds.includes(video.id) && (
                                <div
                                  key={video.id}
                                  className="relative rounded-lg overflow-hidden border bg-black aspect-video group shadow-sm"
                                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="border-2 border-dashed border-purple-200 bg-purple-50/30 rounded-lg p-4 flex flex-col items-center justify-center hover:bg-purple-50 cursor-pointer relative transition-colors">
                      ...
                      {videos.length > 0 && (
                        <span className="text-[10px] bg-purple-600 text-white px-2 py-0.5 rounded-full mt-1">
                          +{videos.length}
                        </span>
                      )}
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      >
                        {isRecording ? (
                          <Square size={12} className="mr-2 animate-pulse" />
                        ) : (
              ...
              <DialogFooter className="px-6 py-4 border-t bg-slate-50 shrink-0">
                <Button
                  ...
                  variant="outline"
                  onClick={onClose}
                  disabled={isLoading || isProcessingLocation}
                >
                  Cancelar
                </Button>
                <Button
                  ...
                  disabled={isLoading || isProcessingLocation}
                  className="bg-[#D35400] hover:bg-[#A04000] text-white min-w-[140px]"
                >
